function [] = ODE_FHN_Simp_mMALA_ICs_PopMCMC(OutputID)
...
MCMC_Options.Upper                 = 0.7;
MCMC_Options.Lower                 = 0.4;
...
if Model.ModelSpecific.InferICs
    ...
    %Model.Sampler_ICs                  = 'Simp_mMALA';
    
    % Choose evaluation function to use - for calculating LL etc
    %Model.Func_Evaluate_ICs            = @ODE_Evaluate_ICs_Simp_mMALA;
    %Model.Func_Proposal_ICs            = @ODE_Proposal_ICs_Simp_mMALA;
...
% Open the given file
InputID                            = 'ODE_FHN_100dps_10Percent.mat';
