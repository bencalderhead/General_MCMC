...
static void test_params() {
  ...
  CU_ASSERT(gmcmc_prior_create(&lognormal, gmcmc_prior_lognormal, 0.0,  0.0) == GMCMC_ERROR_INVALID_ARGUMENT);
  CU_ASSERT(gmcmc_prior_create(&lognormal, gmcmc_prior_lognormal, 0.0, -1.0) == GMCMC_ERROR_INVALID_ARGUMENT);
