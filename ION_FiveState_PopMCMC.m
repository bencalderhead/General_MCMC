function [] = ION_FiveState_PopMCMC(OutputID)
...
Model.ParaNames                    = {'K_+1', 'K_-1', 'K_+2', 'K_-2', 'K*_+2', 'K*_-2', 'Beta_1', 'Alpha_1', 'Beta_2', 'Alpha_2'};
Model.NumOfParas                   = 10;
...
Model.Paras                        = log10([50000000,2000,500000000,2000,500000000,0.333333333333333,15,3000,15000,0.500000000000000]);
Model.StepSize                     = 0.01;
...
Model.ClosedStates                 = [3 4 5];
Model.OpenStates                   = [1 2];
...
% Open the given file
InputID                            = 'ION_Five_State_True_Data_Long.mat';
