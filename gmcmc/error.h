 ...
 * Error handler macro.
 * 
 * Checks that the error handler is not NULL then invokes it with the __func__,
 ...
 * is not GMCMC_SUCCESS.  The function, file and line arguments are
 * automatically populated using the __func__, __FILE__ and __LINE__
 * preprocessor macros.
 * 
 * @see gmcmc_error_handler
 */
